    ...
    <div className="app-shell start-shell">
      ...
      <main className="landing-main">
        <div className="landing-symbols" aria-hidden="true">
          <span className="symbol-card symbol-train">
            <TrainFront />
          </span>
          <span className="symbol-card symbol-route">
            <Route />
          </span>
          <span className="symbol-card symbol-radio">
            <RadioTower />
          </span>
          <span className="symbol-card symbol-trophy">
            <Trophy />
          </span>
        </div>
        ...
        <section className="landing-hero">
          ...
          <form className="landing-form" onSubmit={start}>
            ...
            <div className="secondary-start-control">
              <button
        ...
        >
          <header>
            <div>
              ...
              <h2 id="best-times-title">Bästa tider</h2>
            </div>
            <Link to="/leaderboard">
          ...
          {leaders === null ? (
            <div className="leaderboard-loading">Hämtar tider…</div>
          ) : leaders.length === 0 ? (
            <div className="landing-empty">
              <Trophy size={21} />
              <span>
                <strong>Första rekordet väntar.</strong> Din tid kan bli den
                första.
              </span>
            </div>
          ) : (
            <ol>
              {leaders.map((entry) => (
                <li key={entry.id}>
                  ...
                  <time>{formatElapsed(entry.elapsedMilliseconds)}</time>
                </li>
              ))}
            </ol>
          )}
      ...
      <footer className="event-footer">
        <span>TRAFIKVERKET · GYMNASIUM</span>
        <nav>
          <Link to="/leaderboard">Topplista</Link>
          <Link to="/admin/login">
